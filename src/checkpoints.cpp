...
namespace Checkpoints
{
    ...
    // rawcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // rawcoin: get last synchronized checkpoint
    ...
    // rawcoin: only descendant of current sync-checkpoint is allowed
    ...
    // rawcoin: reset synchronized checkpoint to last hardened checkpoint
...
// rawcoin: sync-checkpoint master key
...
// rawcoin: verify signature of sync-checkpoint message
...
// rawcoin: process synchronized checkpoint

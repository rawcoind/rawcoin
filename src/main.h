...
static const int LAST_POW_BLOCK = 10000; // at 60 second blocks + Pos block will be about 7 days from launch
...
static const uint256 hashGenesisBlock("000001ef2fde70ff291c336679addd645a9159337ec37fa8466152923180c79f");
...
public:
    ...
    {
        // rawcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // rawcoin: get transaction coin age
...
public:
    ...
    // rawcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // rawcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // rawcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // rawcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // rawcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // rawcoin: block index flags
    enum  
    {
